...
const CharacteristicsElement = ({ characteristic }) => {
  const score = characteristic[1].value || 0.2;
  ...
  return (
    <div widgetname="reviews">
      ...
      <div widgetname="reviews" className="container">
        <div widgetname="reviews" className="characteristicsTriple" />
        <div widgetname="reviews" className="characteristicsTriple" />
        <div widgetname="reviews" className="characteristicsTriple" />
        <div widgetname="reviews" style={{ left: `${percent}%` }} className="selector" />
      </div>
